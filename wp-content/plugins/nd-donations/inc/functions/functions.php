...
function nd_donations_get_cause_raised($nd_donations_cause_id){

	$nd_donations_cause_raised = get_post_meta( $nd_donations_cause_id, 'raised', true );
  if ( $nd_donations_cause_raised == '' ) { $nd_donations_cause_raised = 0; } 

	return $nd_donations_cause_raised;

}
function nd_donations_get_cause_subscription($nd_donations_cause_id){

	$nd_donations_cause_subscription = get_post_meta( $nd_donations_cause_id, 'nd_donations_meta_box_subscription', true );
  if ( $nd_donations_cause_subscription == '' ) { $nd_donations_cause_subscription = 0; } 

	return $nd_donations_cause_subscription;
...
function nd_donations_get_total_missing_money_to_goal($nd_donations_cause_id){
  ...
  if ( $nd_donations_cause_id == 0 ) {
    ...
    $nd_donations_get_total_missing_money_to_goal = nd_donations_get_cause_price($nd_donations_cause_id) - nd_donations_get_cause_raised($nd_donations_cause_id);
...
function nd_donations_get_total_donations_percentage($nd_donations_cause_id){
  ...
  $nd_donations_get_total_donations_percentage = nd_donations_get_cause_raised($nd_donations_cause_id)*100/nd_donations_get_cause_price($nd_donations_cause_id);
