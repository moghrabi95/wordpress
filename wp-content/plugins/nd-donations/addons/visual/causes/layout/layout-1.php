...
if ( nd_donations_get_cause_price(get_the_ID()) != 0 ) {
  $current_raised = get_post_meta(get_the_ID(), 'raised', true);
  ...
  $nd_donations_info_donation .= '
    ...
    <div class="nd_donations_section nd_donations_postgrid_causes_single_cause_info_donation">
        <div class="nd_donations_display_table nd_donations_float_left">
            ...
            <p class="nd_donations_display_table_cell nd_donations_vertical_align_middle nd_donations_font_size_13 nd_options_color_greydark nd_donations_display_block_iphone_port nd_donations_display_margin_top_10_iphone_port">'.__('RAISED','nd-donations').' : <span class="nd_options_color_grey">'. $current_raised . nd_donations_get_currency().'</span></p>
        </div>
    </div>
    ...
    <div class="nd_donations_section">
      ...
      <div class="nd_donations_section nd_donations_border_1_solid_grey">
        ...
        <div class="nd_donations_section nd_donations_padding_40 nd_donations_box_sizing_border_box nd_donations_bg_white">
          ...
          <a style="background-color: '.nd_donations_get_cause_color($nd_donations_id).';" class=" add_to_cart_js nd_donations_postgrid_causes_single_cause_button nd_donations_border_radius_30 nd_donations_padding_10_20 nd_donations_display_inline_block nd_donations_color_white_important nd_donations_font_size_14" class="add-to-cart" disabled>add to cart</a>
          <input type="number" id="project-price" placeholder="- ادخل مبلغ التبرع-">
          <input type="hidden" value="'.$nd_donations_id.'" id="project-id">
          <input type="hidden" value="'.$nd_donations_title.'" id="project-name">
          <input type="hidden" value="'.nd_donations_get_cause_subscription($nd_donations_id).'" id="subscription">
