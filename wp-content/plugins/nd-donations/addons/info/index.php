			    ...
			    $nd_donations_info_cause .= '
			    	...
			    	<div class="nd_donations_width_50_percentage nd_donations_width_100_percentage_responsive nd_donations_padding_bottom_0_responsive nd_donations_float_left nd_donations_padding_15 nd_donations_box_sizing_border_box">
			            ...
			            <div id="nd_donations_single_cause_info_bar_achieved_btn" class="nd_donations_width_50_percentage nd_donations_float_left nd_donations_padding_20_0">
			                <a class="nd_donations_width_100_percentage nd_donations_box_sizing_border_box nd_donations_text_align_center nd_donations_display_inline_block nd_donations_color_white_important nd_donations_bg_white_alpha_10 nd_options_first_font nd_donations_padding_15_20 " href="#">'.__('ACHIEVED','nd-donations').' <strong class="nd_donations_border_bottom_2_solid_white">'.get_post_meta(get_the_ID(), 'raised', true).'</strong><strong> '.nd_donations_get_currency().'</strong></a>
			            </div>
			        ...
			        <div class="nd_donations_width_50_percentage nd_donations_width_100_percentage_responsive nd_donations_padding_top_0_responsive nd_donations_margin_bottom_20_responsive nd_donations_float_left nd_donations_padding_15 nd_donations_box_sizing_border_box">
			            ...
			            <div id="nd_donations_single_cause_info_bar_donate_btn" class="nd_donations_width_100_percentage nd_donations_width_100_percentage_all_iphone nd_donations_float_left nd_donations_text_align_right nd_donations_text_align_center_responsive">
			           ...
			           if ( nd_donations_get_total_missing_money_to_goal(get_the_ID()) == 0 AND nd_donations_get_cause_price(get_the_ID()) != 0  ) {
			            	...
			            	$nd_donations_info_cause .= '<a style="background-color:'.nd_donations_get_cause_color(get_the_ID()).';" class="nd_donations_border_radius_30 nd_donations_display_inline_block nd_donations_box_sizing_border_box nd_donations_color_white_important nd_options_first_font nd_donations_padding_10_25 " href="#nd_donations_single_cause_form_section">'.__('DONATE NOW','nd-donations').'</a>
			            	 <a style="background-color: '.nd_donations_get_cause_color(get_the_ID()).';" class=" add_to_cart_js nd_donations_border_radius_30 nd_donations_display_inline_block nd_donations_box_sizing_border_box nd_donations_color_white_important nd_options_first_font nd_donations_padding_10_25" class="add-to-cart" disabled>add to cart</a>
                             <input type="number" id="project-price" placeholder="- ادخل مبلغ التبرع-">
                             <input type="hidden" value="'.get_the_ID().'" id="project-id">
                             <input type="hidden" value="'.get_the_title().'" id="project-name">';
